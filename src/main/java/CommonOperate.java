...
public class CommonOperate {
     ...
     */
    private static CommonOperate instance;
    private CommonOperate(String apiKey, String apiSecret, boolean isInternationalVersion){
        this.apiKey = apiKey;
    ...
    public static CommonOperate getInstance()
    {
    	if(instance == null)
    	{
    		synchronized(CommonOperate.class)
    		{
    			if(instance == null)
    			{
    				instance = new CommonOperate("dIIGbmY70P3OfFYf_qF-Wt776pbF7jGt","_ciNquABD9pMhyKnO4_hPnBbSVzXoNHg",false);
    			}
    		}
    	}
    	return instance;
