...
public class FaceOperate {
     ...
     */
    private static FaceOperate instance;
    private FaceOperate(String apiKey, String apiSecret, boolean isInternationalVersion){
        this.apiKey = apiKey;
    ...
    public static FaceOperate getInstance()
    {
    	if(instance == null)
    	{
    		synchronized(FaceOperate.class)
    		{
    			if(instance == null)
    			{
    				instance = new FaceOperate("dIIGbmY70P3OfFYf_qF-Wt776pbF7jGt","_ciNquABD9pMhyKnO4_hPnBbSVzXoNHg",false);
    			}
    		}
    	}
    	return instance;
