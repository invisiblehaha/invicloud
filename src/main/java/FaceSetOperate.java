...
public class FaceSetOperate {
     ...
     */
    private static FaceSetOperate instance;
    private FaceSetOperate(String apiKey, String apiSecret, boolean isInternationalVersion){
        this.apiKey = apiKey;
    ...
    public static FaceSetOperate getInstance()
    {
    	if(instance == null)
    	{
    		synchronized(FaceSetOperate.class)
    		{
    			if(instance == null)
    			{
    				instance = new FaceSetOperate("dIIGbmY70P3OfFYf_qF-Wt776pbF7jGt","_ciNquABD9pMhyKnO4_hPnBbSVzXoNHg",false);
    			}
    		}
    	}
    	return instance;
     ...
     *  2017年8月16日后，一个 FaceSet 能够存储的 face_token 数量将从 1000 提升至 10000
