    ...
    $(function () {
        $table.bootstrapTable({
            ...
            columns: [
                ...
                {field: 'createTime', title: '创建时间', sortable: true, formatter:'timeFormatter', align: 'center', halign: 'center'},
                {field: 'updateTime', title: '更新时间', sortable: true, formatter:'timeFormatter', align: 'center', halign: 'center'},
